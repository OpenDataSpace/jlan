...
public class OplockLeakTest extends Test {
    private static final Logger LOGGER = LoggerFactory.getLogger(OplockLeakTest.class);
    ...
    public TestResult runTest(final int threadId, final int iteration, final DiskSession sess, final StringWriter log) {
        ...
        try {
            ...
            if (threadId == 1) {
                ...
                try {
                    oplockFile = cifsSess.NTCreate(testFileName, AccessMode.NTReadWrite + AccessMode.NTReadAttrib, FileAttribute.NTNormal,
