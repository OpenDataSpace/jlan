...
public class PerfFolderTreeIT extends ParameterizedJcifsTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(PerfFolderTreeIT.class);
    ...
    private void doTest(
            ...
            final int foldersPerLevel,
            final int filesPerLevel) throws Exception
    {
     ...
     */
    private void createFolderLevel(
            final String rootPath,
            final int curLevel,
            final byte[] ioBuf,
            final ArrayList<String> pathStack,
            final int foldersPerLevel,
            final int filesPerLevel,
    ...
    public void test(
            ...
            @Optional("80") final String fs,
            @Optional("8K") final String ws,
            @Optional("5") final int folderDepth,
            @Optional("5") final int foldersPerLevel,
            @Optional("5") final int filesPerLevel) throws Exception
    {
        long fileSize = 0;
        int writeSize = 0;
        try {
