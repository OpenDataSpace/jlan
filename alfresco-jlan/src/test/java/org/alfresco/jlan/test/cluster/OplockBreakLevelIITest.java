...
public class OplockBreakLevelIITest extends Test {
    private static final Logger LOGGER = LoggerFactory.getLogger(OplockBreakLevelIITest.class);
    ...
    public TestResult runTest(final int threadId, final int iteration, final DiskSession sess, final StringWriter log) {
        ...
        try {
            ...
            if (threadId == 1) {
                ...
                oplockFile = cifsSess.NTCreateWithOplock(testFileName, WinNT.RequestBatchOplock + WinNT.RequestExclusiveOplock, oplockHandler,
                ...
                try {
                    oplockFile = cifsSess.NTCreate(testFileName, AccessMode.NTReadWrite, FileAttribute.NTNormal, SharingMode.READWRITEDELETE,
