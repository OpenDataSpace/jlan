...
public class RemoteOpLockDetails extends OpLockDetailsAdapter implements Serializable {
     ...
     */
    protected RemoteOpLockDetails(final ClusterNode clNode, final int lockTyp, final String path, final ClusterFileStateCache stateCache) {
     ...
     *            ClusterFileStateCache
     */
    protected RemoteOpLockDetails(final ClusterNode clNode, final OpLockDetails localOpLock, final ClusterFileStateCache stateCache) {
        m_ownerName = clNode.getName();
     ...
     *            ClusterFileStateCache
     */
    protected RemoteOpLockDetails(final String ownerName, final int lockTyp, final String path, final ClusterFileStateCache stateCache) {
    ...
    public boolean hasDeferredSessions() {
        ...
        if (getStateCache() != null) {
            final PerNodeState perNode = getStateCache().getPerNodeState(getPath(), false);
            if (perNode != null) {
    ...
    public long getOplockBreakTime() {
        ...
        if (getStateCache() != null) {
            final PerNodeState perNode = getStateCache().getPerNodeState(getPath(), true);
            if (perNode != null) {
     ...
     *            ClusterFileStateCache
     */
    public final void setStateCache(final ClusterFileStateCache stateCache) {
        m_stateCache = stateCache;
    }
