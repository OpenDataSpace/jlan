...
public class NTLMLogonDetails implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = -3244665022162018660L;
     ...
     *            String
     */
    public NTLMLogonDetails(final String user, final String wks, final String domain, final boolean guest, final String authSrv) {
     ...
     *            Object
     */
    public final void setAuthenticationToken(final Object token) {
        m_authToken = token;
    }
     ...
     *            long
     */
    public final void setAuthenticatedAt(final long authTime) {
        m_authTime = authTime;
    }
     ...
     *            String
     */
    public final void setDetails(final String user, final String wks, final String domain, final boolean guest, final String authSrv) {
        m_user = user;
        m_workstation = wks;
        m_domain = domain;
     ...
     *            Type2NTLMMessage
     */
    public final void setType2Message(final Type2NTLMMessage type2) {
        m_type2Msg = type2;
    }
     ...
     *            byte[]
     */
    public final void setNTLMHashedPassword(final byte[] ntlmHash) {
        m_ntlmHash = ntlmHash;
    }
