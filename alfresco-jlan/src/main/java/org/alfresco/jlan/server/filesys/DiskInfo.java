...
public class DiskInfo {
     ...
     *            int
     */
    public DiskInfo(final PCShare shr, final int totunits, final int blkunit, final int blksiz, final int freeunit) {
        if (shr != null) {
     ...
     *            long
     */
    public DiskInfo(final PCShare shr, final long totunits, final int blkunit, final int blksiz, final long freeunit) {
        if (shr != null) {
            m_nodename = shr.getNodeName();
            m_share = shr.getShareName();
        }
