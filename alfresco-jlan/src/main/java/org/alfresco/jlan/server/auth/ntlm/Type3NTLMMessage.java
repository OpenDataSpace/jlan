...
public class Type3NTLMMessage extends NTLMMessage {
     ...
     *            byte[]
     */
    public Type3NTLMMessage(final byte[] buf) {
     ...
     *            boolean
     */
    public Type3NTLMMessage(final byte[] buf, final int offset, final int len, final boolean unicode) {
     ...
     *            int
     */
    public final void buildType3(final byte[] lmHash, final byte[] ntlmHash, final String domain, final String username, final String wksname,
            final byte[] sessKey, int flags) {
        ...
        final int typ3flags = NTLM.FlagNegotiateNTLM + NTLM.FlagRequestTarget;
        if (m_unicode) {
