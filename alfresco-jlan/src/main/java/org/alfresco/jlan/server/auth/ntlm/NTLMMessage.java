...
public abstract class NTLMMessage {
    private static final Logger LOGGER = LoggerFactory.getLogger(NTLMMessage.class);
     ...
     *            int
     */
    protected NTLMMessage(final byte[] buf, final int offset, final int len) {
        m_buf = buf;
        m_offset = offset;
     ...
     *            int
     */
    public final void setMessageType(final int typ) {
     ...
     *            int
     */
    public final void copyFrom(final byte[] buf, final int offset, final int len) {
    ...
    public final byte[] getBytes() {
        final byte[] byts = new byte[getLength()];
     ...
     *            int
     */
    protected void initializeHeader(final int typ, final int flags) {
        // Set the signature
     ...
     * @return int
     */
    protected final int getShortValue(final int offset) {
     ...
     * @return int
     */
    protected final int getIntValue(final int offset) {
     ...
     * @return int
     */
    protected final int getByteOffset(final int offset) {
     ...
     * @return byte[]
     */
    protected final byte[] getByteValue(final int offset) {
        // Get the byte block length
        final int bLen = getShortValue(offset);
        if (bLen == 0) {
            return null;
        }

        final int bOff = getIntValue(offset + 4);
     ...
     * @return byte[]
     */
    protected final byte[] getRawBytes(final int offset, final int len) {

        final byte[] byts = new byte[len];
     ...
     * @return int
     */
    protected final int getStringLength(final int offset) {

        final int bufpos = m_offset + offset;
     ...
     * @return int
     */
    protected final int getStringAllocatedLength(final int offset) {
     ...
     * @return int
     */
    protected final int getStringOffset(final int offset) {
     ...
     * @return String
     */
    protected final String getStringValue(final int offset, final boolean isuni) {
        ...
        final int len = DataPacker.getIntelShort(m_buf, bufpos);
        final int pos = DataPacker.getIntelInt(m_buf, bufpos + 4);
     ...
     * @return String
     */
    protected final String getRawString(final int offset, final int len, final boolean isuni) {
     ...
     *            int
     */
    protected final void setShortValue(final int offset, final int sval) {
     ...
     *            int
     */
    protected final void setIntValue(final int offset, final int val) {
     ...
     *            byte[]
     */
    protected final void setRawBytes(final int offset, final byte[] byts) {
     ...
     *            int[]
     */
    protected final void setRawInts(final int offset, final int[] ints) {
        int bufpos = m_offset + offset;

        for (final int j : ints) {
            DataPacker.putIntelInt(j, m_buf, bufpos);
            bufpos += 4;
        }
    }
     ...
     * @return int
     */
    protected final int setRawString(final int offset, final String str, final boolean isuni) {
     ...
     *            int
     */
    protected final void zeroBytes(final int offset, final int len) {
        int bufpos = m_offset + offset;
        for (int i = 0; i < len; i++) {
            m_buf[bufpos++] = (byte) 0;
        }
     ...
     * @return int
     */
    protected final int setByteValue(final int offset, final byte[] byts, final int dataOffset) {

        final int bytsLen = byts != null ? byts.length : 0;
     ...
     * @return int
     */
    protected final int setStringValue(final int offset, final String val, final int strOffset, final boolean isuni) {
     ...
     *            int
     */
    protected final void setLength(final int len) {
        m_len = len;
    }
     ...
     * @return int
     */
    public final static int isNTLMType(final byte[] buf) {
     ...
     * @return int
     */
    public final static int isNTLMType(final byte[] buf, final int offset) {
        // Validate the buffer
