...
public class GrantAccessParams implements Serializable {
     ...
     *            int
     */
    public GrantAccessParams(final ClusterNode clNode, final FileOpenParams openParams, final int fileSts) {
     ...
     * @return boolean
     */
    protected final boolean hasCreateOption(final int flag) {
