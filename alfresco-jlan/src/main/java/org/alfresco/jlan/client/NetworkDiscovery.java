...
import org.alfresco.jlan.app.Portmap;
...
class NetworkDiscovery extends Thread {
     ...
     */
    public void run() {
        LOGGER.debug("NetworkDiscovery: run () called");
        ...
        try {
            ...
            LOGGER.error("NetworkDiscovery", ex);
            return;
        }
        ...
        while (m_browseMaster == null || m_domainName == null) {
            ...
            try {
                if (LOGGER.isDebugEnabled()) {
                    LOGGER.debug("NetworkDiscovery: Send name lookup request ...");
                ...
                do {
                    ...
                    if (LOGGER.isDebugEnabled()) {
                        ...
                        LOGGER.debug("NetworkDiscovery: Rx Datagram");
                ...
                if (rxOK) {
                    ...
                    LOGGER.debug("NetworkDiscovery: Found browse master {}", m_browseMaster);
                }
            ...
            if (m_browseMaster == null) {
                ...
                try {
                    ...
                    LOGGER.debug("LocalHost Error", ex);
                }
            }
