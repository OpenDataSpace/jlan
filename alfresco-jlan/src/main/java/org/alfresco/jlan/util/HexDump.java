...
public final class HexDump {
     ...
     * @return
     */
    public static final String DumpToString(final byte[] byt, final int len, final int offset) {
    ...
    public static final void Dump(final byte[] byt, final int len, final int offset) {
    ...
    public static final void Dump(final byte[] byt, final int len, final int offset, final PrintStream stream) {

        // Create buffers for the ASCII and Hex output

        final StringBuffer ascBuf = new StringBuffer();
     ...
     *            Offset to start data dump
     * @param dbgDev
     *            Debug device for output
     */

    public static final void Dump(final byte[] byt, final int len, final int offset, final DebugInterface dbgDev) {
     ...
     * @return String
     */
    public static final String hexString(final String str) {
        if (str != null) {
     ...
     * @return String
     */
    public static final String hexString(final String str, final String gap) {
        if (str != null) {
     ...
     * @return String
     */
    public static final String hexString(final byte[] buf) {
     ...
     * @return String
     */
    public static final String hexString(final byte[] buf, final String gap) {
     ...
     * @return String
     */
    public static final String hexString(final byte[] buf, final int len, final String gap) {
        ...
        final StringBuffer hex = new StringBuffer(buflen);
     ...
     * @return String
     */
    public static final String hexString(final byte[] buf, final int off, final int len, final String gap) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            final int curbyt = buf[off + i] & 0x00FF;
     ...
     * @return String
     */
    private static final String generatePositionString(final int off) {

        // Create a buffer position string

        final StringBuffer posStr = new StringBuffer("" + off + " - ");
    ...
    private static final int generateLine(final byte[] byt, int off, final StringBuffer ascBuf, final StringBuffer hexBuf) {
        ...
        for (int i = 0; i < dumplen; i++) {
            ...
            final int curbyt = byt[off++] & 0x00FF;
