...
public class DataBuffer {
     ...
     *            int
     */
    public DataBuffer(final int siz) {
        m_data = new byte[siz];
        m_pos = 0;
        m_offset = 0;
     ...
     *            int
     */
    public DataBuffer(final byte[] buf, final int off, final int len) {
        m_data = buf;
        m_offset = off;
        m_pos = off;
        m_endpos = off + len;
    ...
    public final int getByte() {
        ...
        final int bval = m_data[m_pos] & 0xFF;
        m_pos++;
        return bval;
    }
    ...
    public final int getShort() {
        ...
        final int sval = DataPacker.getIntelShort(m_data, m_pos);
        m_pos += 2;
        return sval;
    }
    ...
    public final int getInt() {
        ...
        final int ival = DataPacker.getIntelInt(m_data, m_pos);
        m_pos += 4;
        return ival;
    }
    ...
    public final long getLong() {
        ...
        final long lval = DataPacker.getIntelLong(m_data, m_pos);
        m_pos += 8;
        return lval;
    }
     ...
     * @return String
     */
    public final String getString(final boolean uni) {
     ...
     * @return String
     */
    public final String getString(int maxlen, final boolean uni) {
     ...
     * @return String
     */
    public final String getFixedString(final int len, final boolean uni) {
     ...
     * @return int
     */
    public final int getShortAt(final int idx) {

        // Check if there is enough data in the buffer

        final int pos = m_offset + (idx * 2);
        ...
        final int sval = DataPacker.getIntelShort(m_data, pos) & 0xFFFF;
        return sval;
    }
     ...
     * @return int
     */
    public final int getIntAt(final int idx) {
        ...
        final int ival = DataPacker.getIntelInt(m_data, pos);
        return ival;
    }
     ...
     * @return long
     */
    public final long getLongAt(final int idx) {
        ...
        final long lval = DataPacker.getIntelLong(m_data, pos);
        return lval;
    }
     ...
     *            int
     */
    public final void skipBytes(final int cnt) {
     ...
     *            int
     */
    public final void setEndOfBuffer(final int endPos) {
        m_endpos = endPos;
        m_pos = m_offset;
    }
     ...
     *            int
     */
    public final void putByte(final int bval) {
     ...
     *            int
     */
    public final void putShort(final int sval) {
     ...
     *            int
     */
    public final void putInt(final int ival) {
     ...
     *            long
     */
    public final void putLong(final long lval) {
     ...
     *            int
     */
    public final void putShortAt(final int idx, final int sval) {
     ...
     *            int
     */
    public final void putIntAt(final int idx, final int ival) {
     ...
     *            long
     */
    public final void putLongAt(final int idx, final int lval) {
     ...
     *            boolean
     */
    public final void putString(final String str, final boolean uni) {
     ...
     *            boolean
     */
    public final void putString(final String str, final boolean uni, final boolean nulTerm) {
     ...
     *            int
     */
    public final void putFixedString(final String str, final int len) {
     ...
     * @return int
     */
    public final int putStringAt(final String str, int pos, final boolean uni, final boolean nulTerm) {
     ...
     * @return int
     */
    public final int putFixedStringAt(final String str, final int len, final int pos) {
     ...
     *            int
     */
    public final void putStringPointer(final int off) {
     ...
     *            int
     */
    public final void putZeros(final int cnt) {
     ...
     *            int
     */
    public final void appendData(final byte[] buf, final int off, final int len) {
     ...
     * @return int
     */
    public final int copyData(final byte[] buf, final int off) {
     ...
     * @return int
     */
    public final int copyData(final byte[] buf, final int off, final int cnt) {
     ...
     *            int
     */
    private final void extendBuffer(final int ext) {
        ...
        final byte[] newBuf = new byte[m_data.length + ext];
