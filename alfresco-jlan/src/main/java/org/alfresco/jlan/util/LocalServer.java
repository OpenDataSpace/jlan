...
public class LocalServer {
     ...
     * @return String
     */
    public static final String getLocalServerName(final boolean trimDomain) {
    ...
    public static final String getLocalDomainName() {
        ...
        if (Platform.isPlatformType() == Platform.Type.WINDOWS) {
            ...
            try {
                ...
                final NetBIOSNameList nbNameList = NetBIOSSession.FindNamesForAddress(nbName.getIPAddressString(0));
                if (nbNameList != null) {
