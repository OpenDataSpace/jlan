...
public final class DataPacker {
     ...
     */
    public final static String getDataString(final char typ, final byte[] bytarray, int pos, final int maxlen, final boolean uni) {
     ...
     */
    public final static int getInt(final byte[] buf, final int pos) throws java.lang.IndexOutOfBoundsException {
        ...
        final int i1 = buf[pos] & 0xFF;
        final int i2 = buf[pos + 1] & 0xFF;
        final int i3 = buf[pos + 2] & 0xFF;
        final int i4 = buf[pos + 3] & 0xFF;

        final int iVal = (i1 << 24) + (i2 << 16) + (i3 << 8) + i4;
     ...
     *                If there is not enough data in the buffer.
     */
    public final static int getIntelInt(final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
        ...
        final int i1 = bytarray[pos + 3] & 0xFF;
        final int i2 = bytarray[pos + 2] & 0xFF;
        final int i3 = bytarray[pos + 1] & 0xFF;
        final int i4 = bytarray[pos] & 0xFF;
     ...
     *                If there is not enough data in the buffer.
     */
    public final static long getLong(final byte[] buf, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static long getIntelLong(final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static int getIntelShort(final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
        ...
        final int sVal = ((bytarray[pos + 1] << 8) + (bytarray[pos] & 0xFF));
     ...
     *                If there is not enough data in the buffer.
     */
    public final static int getShort(final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
        ...
        if (bigEndian == true) {
            ...
            sVal = (((bytarray[pos + 1]) << 8) + (bytarray[pos] & 0xFF));
        } else {

            // Little endian

            sVal = (((bytarray[pos]) << 8) + (bytarray[pos + 1] & 0xFF));
        }
     ...
     * @return String, else null if the terminating null character was not found.
     */
    public final static String getString(final byte[] bytarray, final int pos, final int maxlen) {

        // Search for the trailing null

        final int maxpos = pos + maxlen;
        int endpos = pos;
     ...
     * @return String, else null if the terminating null character was not found.
     */
    public final static String getString(final byte[] bytarray, final int pos, final int maxlen, final boolean isUni) {
     ...
     * @return String, else null if the terminating null character was not found.
     */
    public final static String getUnicodeString(final byte[] byt, final int pos, final int maxlen) {
        ...
        final int maxpos = pos + (maxlen * 2);
        int endpos = pos;
        final char[] chars = new char[maxlen];
        int cpos = 0;
        char curChar;
     ...
     */
    public final static void putInt(final int val, final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static void putIntelInt(final int val, final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static void putLong(final long val, final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static void putIntelLong(final long val, final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static void putIntelLong(final int val, final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static void putIntelShort(final int val, final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     *                If there is not enough data in the buffer.
     */
    public final static void putShort(final int val, final byte[] bytarray, final int pos) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public final static int putString(final String str, final byte[] bytarray, final int pos, final boolean nullterm) {

        // Get the string as a byte array

        final byte[] byts = str.getBytes();

        // Pack the data bytes

        int bufpos = pos;

        for (final byte byt : byts) {
            bytarray[bufpos++] = byt;
        }
     ...
     * @return The ending buffer position
     */
    public final static int putString(final String str, final int fldLen, final byte[] bytarray, final int pos) {
     ...
     * @return The ending buffer position
     */
    public final static int putString(final String str, final byte[] bytarray, final int pos, final boolean nullterm, final boolean isUni) {
     ...
     * @return The ending buffer position
     */
    public final static int putUnicodeString(final String str, final byte[] bytarray, final int pos, final boolean nullterm) {
     ...
     *                If the buffer does not have enough space.
     */
    public final static void putZeros(final byte[] buf, final int pos, final int cnt) throws java.lang.ArrayIndexOutOfBoundsException {
     ...
     * @return int
     */
    public final static int wordAlign(final int pos) {
     ...
     * @return int
     */
    public final static int longwordAlign(final int pos) {
     ...
     * @return int
     */
    public final static int getStringLength(final String str, final boolean uni, final boolean nul) {
     ...
     * @return int
     */
    public final static int getBufferPosition(final int pos, final String str, final boolean uni, final boolean nul) {
