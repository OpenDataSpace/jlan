...
public class NameValueList {
    ...
    private final Vector<NameValue> m_list;
     ...
     *            NameValue
     */
    public final void addItem(final NameValue nameVal) {
        m_list.add(nameVal);
    }
     ...
     * @return NameValue
     */
    public final NameValue getItemAt(final int idx) {
     ...
     * @return NameValue
     */
    public final NameValue findItem(final String name) {
        for (int i = 0; i < m_list.size(); i++) {
            final NameValue nameVal = m_list.get(i);
     ...
     */
    public final NameValueList findAllItems(final String name) {
     ...
     * @return NameValue
     */
    public final NameValue findItemCaseless(final String name) {
        for (int i = 0; i < m_list.size(); i++) {
            final NameValue nameVal = m_list.get(i);
    ...
    public String toString() {
        ...
        for (int i = 0; i < numberOfItems(); i++) {
            ...
            final NameValue nameVal = getItemAt(i);
