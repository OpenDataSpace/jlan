...
public class StringList {
     ...
     *            Vector
     */
    public StringList(final Vector list) {
     ...
     * @return String
     */
    public final String getStringAt(final int idx) {
     ...
     * @return boolean
     */
    public final boolean containsString(final String str) {
     ...
     * @return int
     */
    public final int findString(final String str) {
     ...
     * @return boolean
     */
    public final boolean removeString(final String str) {
     ...
     * @return String
     */
    public final String removeStringAt(final int idx) {
        if (idx < 0 || idx >= m_list.size()) {
            return null;
        }
