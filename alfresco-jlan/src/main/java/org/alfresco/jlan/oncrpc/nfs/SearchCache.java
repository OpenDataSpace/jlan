...
public class SearchCache {
    ...
    private final SearchEntry[] m_searches;
    private int m_lastIdx;

    // Search timeout

    private final long m_searchTmo = DefaultSearchTimeout;
    ...
    protected class SearchEntry {
        ...
        private final SearchContext m_search;
         ...
         *            SearchContext
         */
        public SearchEntry(final SearchContext search) {
            m_search = search;
            updateTimeout();
        }
    ...
    protected class SearchExpiry implements Runnable {
         ...
         *            long
         */
        public SearchExpiry(final long wakeup) {
                ...
                synchronized (m_searches) {
                    ...
                    for (int i = 0; i < m_searches.length; i++) {
                        ...
                        if (m_searches[i] != null && m_searches[i].getTimeout() < timeNow) {
                            ...
                            final SearchEntry entry = m_searches[i];
                            m_searches[i] = null;
                            ...
                            if (LOGGER.isDebugEnabled() && hasDebug()) {
                                LOGGER.debug("NFSSearchExpiry: Closed search=" + entry.getSearch().getSearchString() + ", id=" + i);
                            }
                        }
                    }
                }
     ...
     * @return int
     */
    public final int allocateSearchId(final SearchContext search) {
        ...
        synchronized (m_searches) {
            ...
            while (cnt < MaximumSearches) {
                ...
                if (m_searches[m_lastIdx] == null) {
                    ...
                    final SearchEntry entry = new SearchEntry(search);
     ...
     *            int
     */
    public final void releaseSearchId(final int id) {
     ...
     * @return SearchContext
     */
    public final SearchContext getSearch(final int id) {
